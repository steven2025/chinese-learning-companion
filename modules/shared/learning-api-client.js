(function () {
  ...
  window.LearningApi = Object.freeze({
    ...
    adminCourseStudents: (input) => request("/admin/courses/students", input),
    adminOverview: () => request("/admin/overview", {}),
    adminLocales: () => request("/admin/locales", {}),
    updateAdminLocales: (input) => request("/admin/locales/update", input),
    ...
    learningEvent: (input) => request("/learning/event", input),
    practiceRecord: (input) => request("/practice/record", input),
    practiceReport: (input) => request("/practice/report", input),
    teacherLessonDetails: (input) => request("/teacher/lesson-details", input),
    ...
    aiTeacherPrepare: (input) => request("/ai-teacher/prepare", input || {}),
    aiTeacherProfile: (input) => request("/ai-teacher/profile", input || {}),
    aiTeacherSaveEvaluation: (input) => request("/ai-teacher/evaluation/save", input || {}),
    uploadJson,
    writingAssist,
